 ...
 * @param {object} [options] - { userId, chatTitle, llmProvider, llmModel } for DB persistence and model override
 * @returns {Promise<string>} AI response text
 */
async function chat(threadId, message, attachments = [], options = {}) {
  const agent = await getAgent({ provider: options.llmProvider, model: options.llmModel });
 ...
 * @param {object} [options] - { userId, chatTitle, skipUserPersist, llmProvider, llmModel } for DB persistence/model override
